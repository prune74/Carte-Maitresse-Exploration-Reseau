...
- readFile() :
    ...
    • Récupère :
        ...
        - track_profile → profil voie (0=N, 1=HO)
...
void DiscoveryMaster_Settings::readFile()
{
    ...
    // Profil voie (N / HO)
    DiscoveryMaster_Settings::track_profile = doc["track_profile"] | 0;

    Serial.printf("ID dernier satellite : %d\n", DiscoveryMaster_Settings::idNode);
    Serial.printf("WiFi SSID : %s\n", DiscoveryMaster_Settings::WIFI_SSID.c_str());
    Serial.printf("Profil voie : %s\n",
                  DiscoveryMaster_Settings::track_profile == 0 ? "N (12V)" : "HO (15V)");
