...
// Paramètres failsafe
// ---------------------------------------------------------------------------
static const uint32_t ERS_TIMEOUT_MS   = 500;  // délai max sans heartbeat
static const uint32_t ERS_PERIOD_MS    = 250;  // période de supervision
static const uint32_t ERS_RX_PERIOD_MS = 1;    // période de lecture CAN
