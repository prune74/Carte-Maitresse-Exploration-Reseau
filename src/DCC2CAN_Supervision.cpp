 ...
 *
 * Cette supervision est totalement indépendante :
 *   • du décodeur DCC
 *   • du CAN
 *   • du cutout
 *
 ...
 *   • g_state.status         → état logique du système
 *
 * Objectifs :
 *   1) attendre le premier événement avant d’activer la supervision
 *   2) détecter une absence prolongée de signal (failsafe)
 *   3) basculer RUNNING → RECOVERY
 *   4) repasser en RUNNING lorsque le signal revient
 *
 * Contraintes temps réel
 * ----------------------
 * Cette tâche tourne à faible priorité (20 ms).
 * Elle ne doit jamais bloquer ni interférer avec taskDcc ou taskCan.
 */
